...
//import CryptoKit
//
//// MARK: - Approach 1: Custom Either Type
//
///// Generic Either type for sum types
...
//    let algorithm: AsymmetricAlgorithm
//    let privateKey: Data
//    let publicKey: Data
//    
//    enum AsymmetricAlgorithm {
//        case rsa2048, rsa4096, curve25519
//    }
//}
//
//// MARK: - Approach 1: Either-based Extensions
//
//extension String {
//    
//    /// Decrypt with Either configuration
//    func decrypted(with config: Either<SymmetricConfig, AsymmetricConfig>) throws -> String {
//        return try config.fold(
//            left: { symmetricConfig in
//                return try self.decryptedSymmetric(with: symmetricConfig)
//            },
//            right: { asymmetricConfig in
//                return try self.decryptedAsymmetric(with: asymmetricConfig)
//            }
//        )
//    }
//    
//    /// Encrypt with Either configuration
//    func encrypted(with config: Either<SymmetricConfig, AsymmetricConfig>) throws -> String {
//        return try config.fold(
//            left: { symmetricConfig in
//                return try self.encryptedSymmetric(with: symmetricConfig)
//            },
//            right: { asymmetricConfig in
//                return try self.encryptedAsymmetric(with: asymmetricConfig)
//            }
//        )
//    }
//}

struct Encrypting<A, Config> {
    let cypher: @Sendable (A, Config) -> (Config) -> A
}

extension Encrypting where A == String, Config == SomeConfig {
    static let live(config: Config) -> Encrypting<A, Config> {
        return {
            $0(config)
        }
    }
...
//struct Encrypting<A, Config> {
//    let cypher: @Sendable (A, Config, @escaping @Sendable (A, Config) -> A) -> A
//}
//
//extension Encrypting where A == String, Config == SomeConfig {
//    static func live(value: A, confgi: Confg) -> Encrypting<A, Config> {
//        Encrypting {
//            c(value, confgi)
//        }
//    }
