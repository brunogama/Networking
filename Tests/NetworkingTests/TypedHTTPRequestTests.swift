...
struct TypedHTTPRequestTests {
  ...
  func testRequestConstructsCorrectURL() {
  ...
  func testRequestPathWithLeadingSlash() {
  ...
  func testRequestCustomProperties() {
  ...
  func testConversionToHTTPRequest() {
  ...
  func testWithBody() {
    ...
    let modified = request.withBody(body)
  ...
  func testHTTPClientExecuteTyped() async throws {
    let mockClient = MockNetworkClient()
    mockClient.stubGET(path: "/users", response: #"[]"#.data(using: .utf8)!)
