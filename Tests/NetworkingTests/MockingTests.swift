...
struct MockingTests {
  ...
  func testMockURLProtocolBasicStubbing() async throws {
    ...
    await MockURLProtocol.expectRequest(url: "https://api.example.com/users/123")
  ...
  func testMockNetworkClientBasicExpectations() async throws {
    struct User: Codable {
      let id: Int
      let name: String
    }
  ...
  func testMockNetworkClientCallCountExpectations() async throws {
    let mockClient = MockNetworkClient()
  ...
  func testMockNetworkClientRequestCapture() async throws {
    let mockClient = MockNetworkClient()
  ...
  func testMockNetworkClientErrorExpectations() async throws {
    let mockClient = MockNetworkClient()
  ...
  func testMockNetworkClientTimeoutExpectations() async throws {
    let mockClient = MockNetworkClient()
  ...
  func testMockNetworkClientConvenienceMethods() async throws {
    struct User: Codable {
      let id: Int
      let name: String
    }
  ...
  func testMockNetworkClientRequestHistoryFiltering() async throws {
    let mockClient = MockNetworkClient()
  ...
  func testMockNetworkClientPerformanceMeasurement() async throws {
    let mockClient = MockNetworkClient()
    let responseData = Data(repeating: 0x41, count: 10_000)  // 10KB of data
    ...
    #expect(metrics.responseSize == 10_000)
  ...
  func testMockNetworkClientUnfulfilledExpectations() async throws {
    let mockClient = MockNetworkClient()
  ...
  func testMockNetworkClientResetFunctionality() async throws {
    let mockClient = MockNetworkClient()
