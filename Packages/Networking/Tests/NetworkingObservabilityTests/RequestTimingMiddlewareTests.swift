...
final class RequestTimingMiddlewareTests: XCTestCase {
    ...
    func testRequestMetricsRequestBodySize() {
        ...
        XCTAssertEqual(metrics.requestBodySize, bodyData.count)
    }
    ...
    func testRequestMetricsWithNilBody() {
        ...
        XCTAssertEqual(metrics.requestBodySize, 0)
    }
    ...
    func testRequestMetricsWithMetadata() {
        ...
        XCTAssertEqual(metrics.metadata["key1"], "value1")
        XCTAssertEqual(metrics.metadata["key2"], "value2")
    }
    ...
    func testConfigurationShouldCollectMetricsPredicate() {
        ...
        XCTAssertTrue(config.shouldCollectMetrics(getRequest))
        XCTAssertFalse(config.shouldCollectMetrics(postRequest))
    }
    ...
    func testConfigurationMetadataGenerator() {
        ...
        XCTAssertEqual(metadata["method"], "GET")
    }
    ...
    func testMemoryMetricsCollectorSuccessfulRequests() async {
        ...
        XCTAssertTrue(successful.first?.isSuccess ?? false)
    }
    ...
    func testMemoryMetricsCollectorFailedRequests() async {
        ...
        XCTAssertFalse(failed.first?.isSuccess ?? true)
    }
    ...
    func testMemoryMetricsCollectorAverageResponseTime() async {
        ...
        XCTAssertEqual(average, 0.2, accuracy: 0.01)
    }
    ...
    func testMemoryMetricsCollectorP95ResponseTime() async {
        ...
        XCTAssertGreaterThan(p95, 0.9)
        XCTAssertLessThanOrEqual(p95, 1.0)
    }
    ...
    func testLoggingMetricsCollectorLogLevels() {
        ...
        XCTAssertEqual(LoggingMetricsCollector.LogLevel.debug.rawValue, "DEBUG")
        XCTAssertEqual(LoggingMetricsCollector.LogLevel.info.rawValue, "INFO")
        XCTAssertEqual(LoggingMetricsCollector.LogLevel.warning.rawValue, "WARNING")
        XCTAssertEqual(LoggingMetricsCollector.LogLevel.error.rawValue, "ERROR")
    }
