...
struct SequentialMockTests {
  ...
  func testSequentialRequestsMatchInOrder() async throws {
    ...
    let respondSecond = Respond {
      Status(.ok)
      Body(Data(#"{"id": 1, "name": "Alice"}"#.utf8))
    }
  ...
  func testDifferentResponsesForIdenticalRequests() async throws {
  ...
  func testMismatchedRequestDoesNotMatch() async throws {
  ...
  func testUnexpectedCallAfterExpectationsConsumed() async throws {
  ...
  func testVerifyAllExpectationsConsumedThrows() async throws {
