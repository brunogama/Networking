...
struct PhantomTypesTests {
  ...
  func postRequest_canAddJSONBody() throws {
    ...
    let decoded = try JSONDecoder().decode(User.self, from: requestWithBody.body!.rawValue)
  ...
  func putRequest_canAddJSONBody() throws {
    ...
    let decoded = try JSONDecoder().decode(
      UpdateData.self,
      from: requestWithBody.body!.rawValue
    )
  ...
  func patchRequest_canAddJSONBody() throws {
    ...
    let decoded = try JSONDecoder().decode(PatchData.self, from: requestWithBody.body!.rawValue)
  ...
  func withJSONBody_usesCustomEncoder() throws {
    ...
    let json =
      try JSONSerialization.jsonObject(
        with: requestWithBody.body!.rawValue
      ) as? [String: Any]
  ...
  func typedRequest_convertsToHTTPRequest() {
    ...
    #expect(http.timeout == RequestTimeout(45.0))
  }
  ...
  func typedPostWithBody_convertsToHTTPRequest() throws {
    ...
    let decoded = try JSONDecoder().decode(User.self, from: http.body!.rawValue)
