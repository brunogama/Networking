...
Learn how to integrate and use ModernNetworking in your Swift applications.

## Overview

ModernNetworking provides a modern, declarative approach to HTTP networking in Swift. This guide will walk you through the basics of setting up and using the framework.

## Installation

### Swift Package Manager

Add ModernNetworking to your project using Swift Package Manager:

```swift
dependencies: [
    .package(url: "https://github.com/yourorg/ModernNetworking", from: "1.0.0")
]
```
...
ModernNetworking provides comprehensive error handling:
